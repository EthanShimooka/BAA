...
enum JoystickButton{
	...
	JOYSTICK_GUIDE = SDL_CONTROLLER_BUTTON_GUIDE,
	JOYSTICK_START = SDL_CONTROLLER_BUTTON_START,
	JOYSTICK_LEFTSTICK = SDL_CONTROLLER_BUTTON_LEFTSTICK,
	JOYSTICK_RIGHTSTICK = SDL_CONTROLLER_BUTTON_RIGHTSTICK,
	JOYSTICK_LEFTSHOULDER = SDL_CONTROLLER_BUTTON_LEFTSHOULDER,
	JOYSTICK_RIGHTSHOULDER = SDL_CONTROLLER_BUTTON_RIGHTSHOULDER,
	JOYSTICK_DPAD_UP = SDL_CONTROLLER_BUTTON_DPAD_UP,
	JOYSTICK_DPAD_DOWN = SDL_CONTROLLER_BUTTON_DPAD_DOWN,
	JOYSTICK_DPAD_LEFT = SDL_CONTROLLER_BUTTON_DPAD_LEFT,
	JOYSTICK_DPAD_RIGHT = SDL_CONTROLLER_BUTTON_DPAD_RIGHT,
