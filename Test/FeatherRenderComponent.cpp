...
FeatherRenderComponent::FeatherRenderComponent(GameObject* feather){
	...
	allObjs["feather1"] = sceneMan->InstantiateObject(sceneMan->findLayer("layer1"), 8000, 3000, 0);
	allObjs["feather2"] = sceneMan->InstantiateObject(sceneMan->findLayer("layer1"), 8001, 3000, 0);
